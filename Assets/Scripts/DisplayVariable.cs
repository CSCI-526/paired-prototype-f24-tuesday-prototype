...
{
    public enum InfoType { SYSTEM_INFO, RESOURCE_INFO, STATISTIC_INFO, BUDGET_INFO };
    ...
    void Update()
    {
        ...
        {
            string newText = "";
            FieldInfo[] fields = gameVariables.budgetInfo.GetType().GetFields(BindingFlags.Public | BindingFlags.Instance);
            foreach (FieldInfo field in fields)
                newText += $"{field.Name}: {field.GetValue(gameVariables.budgetInfo)}\n";
